...
const ArticleLayout = ({
  ...
  }, [category, title, subtitle, slug, isoDate]);
  ...
  return (
    <article className="bg-white">
      <header className={`relative overflow-hidden bg-gradient-to-br ${heroGradient || 'from-secondary via-secondary/90 to-primary/70'} text-white`}>
        ...
        <div className="relative max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 py-20 md:py-28">
          ...
          <div className="mt-8 flex items-center gap-6 text-sm text-white/70 font-heading">
